...
export default function HelperDashboardPortfolio() {
              ...
              <div className="sticky top-16 z-50 flex items-center justify-end border-t border-gray-300 bg-white py-8 md:py-10">
                <div className="mr-auto flex items-center space-x-4 px-4">
                  ...
                  <div className="">
                    ...
                    <p className="md:text-md mt-1 max-w-40 text-xs text-gray-400 sm:max-w-full sm:text-sm">
                      List of all your activities and help rendered
                    </p>
                  </div>
                </div>
