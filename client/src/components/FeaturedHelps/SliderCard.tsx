...
export default function SliderCard({ image, title, link }: ISliderCard) {
  return (
    <div className="relative flex w-72 flex-col space-y-3 rounded-lg border border-helpMe-200 shadow-lg">
      ...
      <div className="flex w-full flex-col space-y-3 p-4">
        <h4 className="w-full pb-4 font-bold text-black/75">{title}</h4>
        <hr />
        <Link
